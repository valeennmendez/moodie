  ...
  return (
    <div className="min-h-[91.8vh] w-full bg-base-200 flex flex-col items-center p-10">
      <div className="text-center">
        ...
        <h3 className="text-base-content/80 font-semibold text-2xl">
          ¿Cómo te sentís hoy?
        </h3>
      </div>
      ...
      <div className="w-sm sm:w-md md:w-lg lg:w-xl px-5 sm:px-0">
        <div
          ...
          } h-14 mt-0 sm:mt-5 rounded-md flex justify-center items-center gap-2 transition-colors duration-300 cursor-pointer`}
        >
          <span
            className={`font-medium ${
              selectedMood ? `text-primary-content` : `text-base-content/30`
            }`}
          >
            Continuar
          </span>
      ...
      <span className="sm:text-sm mt-2 text-base-content/40 text-[10px] text-center">
